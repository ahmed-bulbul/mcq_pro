...
import com.bulbul.examportal.entity.payment.SSLCommerzInitResponse;
import com.bulbul.examportal.entity.payment.SSLCommerzValidatorResponse;
import com.bulbul.examportal.utils.payments.ParameterBuilder;
import com.bulbul.examportal.utils.payments.Util;
...
public class SSLCommerz {
    ...
    private String storeId="bdsof60729f7f07943";
    private String storePass="bdsof60729f7f07943@ssl";
    ...
    private String sslczURL = "https://sandbox.sslcommerz.com/";
    ...
    private void setSSLCzTestMode(boolean storeTestMode) {
        ...
        if (storeTestMode) {
            this.storeId = "bdsof60729f7f07943";
            this.storePass = "bdsof60729f7f07943@ssl";
    ...
    public String initiateTransaction(Map<String, String> postData, boolean isGetGatewayList) throws Exception {
        System.out.println("Entered initiate transaction");
